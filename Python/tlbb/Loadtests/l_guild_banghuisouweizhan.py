...
class GameLocust(Locust):
    def __init__(self, *args, **kwargs):
        ...
        #到达npc的位置 程佰文
        self.client.ACG_CHARMOVE(89.3899993896, 113.819999695)
        gevent.sleep(1)
        self.client.ACGIdle()
        self.client.ACG_CHARMOVE(90.883682251, 112.677688599)
        gevent.sleep(1)
        self.client.ACGIdle()

        #打开npc界面
        self.client.ACGCharDefaultEvent(31)
        gevent.sleep(3)
        self.client.ACGIdle()
        self.client.ACGEventRequest(31, 600003, 1, False)
        gevent.sleep(3)
        self.client.ACGIdle()
        self.client.ACGEventRequest(31, 600003, 3)
        gevent.sleep(3)
        self.client.ACGIdle()
        ...
        pos = posLs[int(self.client['userName'][1:]) % 4 ]
        self.client.taskqueue_append("battle_banghuisouweizhan", 0, pos[0], pos[1], 3)
