...
class ALoginAttackLargeContent():
    ...
    def run(self):
        ...
        sendstream = sendstream + binascii.unhexlify(random.choice('0123456789ABCDEF') + random.choice('0123456789ABCDEF')) + binascii.unhexlify(random.choice('0123456789ABCDEF') + random.choice('0123456789ABCDEF'))
    
        self.person['socket'].send(sendstream)
        return (True,0,"Send large content login attack successfully.")